...
public class TutorialWalrus extends NPC {
    ...
    //
    public void setMessage(SpriteFont in) {
        message = in;
    }
    ...
    public void drawMessage(GraphicsHandler graphicsHandler) {
        ...
        graphicsHandler.drawFilledRectangleWithBorder(Math.round(getCalibratedXLocation() - 2), Math.round(getCalibratedYLocation() - 24), 250, 25, Color.WHITE, Color.BLACK, 2);
